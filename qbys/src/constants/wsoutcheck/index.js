            ...
            result.then((res) => {
                ...
                if(json.code=='0'){
                    ...
                    if(json.checkFinish=="true"){
                        ...
                        this.props.dispatch({
                            type:'postcheck/initstate',
                            payload:{}
                        });
                        const ValueorderNoses=ReactDOM.findDOMNode(this.refs.peiorder)
                        ValueorderNoses.focus()
                        //加成功信息提示音
                        let audios = ReactDOM.findDOMNode(this.refs.success);
                        audios.play()
                    }else{
    ...
    render() {
        return (
            <div>
                ...
                <Audio ref='error' url='../../static/error.mp3'/>
                <Audio ref='success' url='../../static/success.mp3'/>
                <Audio ref='scanSuccess' url='../../static/scanSuccess.mp3'/>
            </div>
