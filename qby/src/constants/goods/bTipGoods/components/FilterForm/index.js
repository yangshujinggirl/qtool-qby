          ...
          <div className="search-form-wrap">
            ...
            <FormItem label='一级分类'>
               {getFieldDecorator('pdCategory1Name')(
                 <Select placeholder="请输入一级分类" autoComplete="off">
            ...
            <FormItem label='售卖状态'>
               {getFieldDecorator('status')(
                 <Select placeholder="请选择售卖状态" autoComplete="off">
                   <Option value={20} key={20}>售卖</Option>
                   <Option value={10} key={10}>停售</Option>
                 </Select>
               )}
            ...
            <FormItem label='预售商品'>
               {getFieldDecorator('isPresell')(
                 <Select allowClear={true} placeholder="请选择预售商品" autoComplete="off">
            ...
            <FormItem label='直邮商品'>
               {getFieldDecorator('isDirectExpress')(
                 <Select allowClear={true} placeholder="请选择直邮商品" autoComplete="off">
                     <Option value={1} key={1}>是</Option>
                     <Option value={0} key={0}>否</Option>
                 </Select>
               )}
