...
class LeftAddType extends Component{
	//新增添加的类型
	addNewItem = (type) =>{
  	...
  	render(){
     	return(
          ...
          <ul className='add-list'>
            <li onClick={()=>this.addNewItem(1)}>新增图片</li>
            <li onClick={()=>this.addNewItem(2)}>新增商品</li>
            <li onClick={()=>this.addNewItem(3)}>新增文本</li>
            <li onClick={()=>this.addNewItem(4)}>新增规则</li>
          </ul>
        </div>
    	)
	}
