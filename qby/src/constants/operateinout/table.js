...
class OperateinoutTable extends React.Component {
    ...
    lookInfo = (record) =>{
        ...
        if(record.type=='25'){
            const paneitem={title:'收银对账',key:'402000edit'+record.outId+'infomoney',data:{spShopId:record.spShopId,type:record.type,dayTime:record.dayTime,spMoneyDetailId:record.spMoneyDetailId},componkey:'402000infoMoney'}
            this.props.dispatch({
                type:'tab/firstAddTab',
                payload:paneitem
            })
